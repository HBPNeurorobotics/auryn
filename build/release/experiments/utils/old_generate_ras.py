    ...
    with pd.HDFStore(
        ...
        for sample_id in tqdm(sample_ids):
            ...
            if cache and key in store:
                ...
                sample_id_padded = '{0:05d}'.format(sample_id + 1)
                timestamps, neuron_id, pol = load_events_from_aedat(
                    "data/{exp_dir}/{test_or_train}/{tot}{s_id}.aedat".format(test_or_train=test_or_train,
                                                                              exp_dir=exp_directory, s_id=sample_id_padded,
                                                                              tot=tot))

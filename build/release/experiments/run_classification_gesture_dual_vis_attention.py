...
def run_classify(context, labels_test, sample_duration_test):
    ...
    plotter.plot_output_spike_count(ouput_spikes_per_label, 'Output spike count per label', save=True,
                                    image_title='out_spk')
    plotter.plot_output_spike_count(ouput_spikes_per_label_norm, 'Normalized ouput spike count per label', save=True,
...
context = {'ncores': 4,
           ...
           'nv': ((32 * 32) * 2) + 2 * 128 + 12,  # Include nc
           'nh': 400,
           'nh2': 200,
           'nh1': 200,
           'nc': 12,
    ...
    try:
        ...
        if new_test_data:
            ...
            sample_duration_test, labels_test = gras.create_ras_from_aedat(n_samples_test,
                                                                           ...
                                                                           cache=True,
                                                                           max_neuron_id=context['nv'] - 128 * 2 -
                                                                                         context['nc'],
                                                                           delay=context['delay'],

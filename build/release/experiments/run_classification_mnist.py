#!/bin/python
#-----------------------------------------------------------------------------
# File Name : run_classification_mnist.py
# Purpose: Training with eRBP using external source of spikes
#
# Author: Emre Neftci
#
# Creation Date : 01-04-2015
# Last Modified : Mon 16 Feb 2017 09:01:49 AM PST
...
def run_learn(context):
    ...
    run_cmd = 'mpirun -n {ncores} ./exp_rbp \
        --learn true \
...
context={'ncores':4,
         ...
         'fve': 'fwmat_ve.mtx',
         'feh': 'fwmat_eh.mtx',
         'ip_v': 'input_pattern_file', #Hard-coded
         'beta_prm' : 1.0,
         'tau_rec' : 4e-3,
         'tau_ref' : 4e-3,
         'seed' : 12,

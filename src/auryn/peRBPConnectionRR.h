...
#ifndef PERBPDCONNECTIONRR_H_
#define PERBPDCONNECTIONRR_H_
...
//  
//*/
class peRBPConnectionRR : public SparseConnection
{
private:
...
//
  ...
  AurynWeight rr(AurynWeight weight);
